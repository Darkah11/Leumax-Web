  ...
  return (
    <main className=" relative text-lg">
        ...
        <div className=" text-white-10 absolute left-0 right-0 m-auto top-0 bottom-0 flex flex-col items-center justify-center max-w-[600px] text-center">
          <h2 className=" text-5xl">Max Academy</h2>
      ...
      <section className=" px-16 py-24 ">
        <div className=' flex items-center justify-between'>
            <h2 className=' text-5xl font-medium max-w-[500px]'>Explore our training programme</h2>
            <p className=' max-w-[500px]'>We have years of experience and hands-on you can bank on. We develop Solutions and Tools to ease your business process via the web. </p>
        </div>
        ...
        <div className=' mt-24 max-w-[1000px] m-auto flex flex-col gap-24'>
          ...
          <div className=' flex items-center justify-between'>
            <Image src={tech2jobs} alt=' working man image'/>
          ...
          <div className=' flex items-center justify-between'>
            <Image src={tech2kids} alt=' kids image'/>
            <div className=' max-w-[500px]'>
          ...
          <div className=' flex items-center justify-between'>
            <Image src={corps2tech} alt=' corps image'/>
            <div className=' max-w-[500px]'>
          ...
          <div className=' flex items-center justify-between'>
            <Image src={tech2bus} alt=' woman image'/>
            <div className=' max-w-[500px]'>
      ...
      <section className=" px-16 py-24">
        <div className=' max-w-[700px] m-auto text-center '>
            <h2 className=' text-5xl font-medium pb-4'>Our Trained Alumni</h2>
